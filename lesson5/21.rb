class Card
  ...
  def face #face getter method -> converting letter to word or returning number
    case @face
    when 'J' then 'Jack'
    when 'Q' then 'Queen'
    when 'K' then 'King'
  ...
  def suit #suit getter methd -> converting letter to suit word
    case @suit
    when 'H' then 'Hearts'
...
class Dealer < Participant
  ROBOTS = ['Bumblee', 'R2D2', 'C3PO', 'Walle', 'Fred']
